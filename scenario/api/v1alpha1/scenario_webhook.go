...
//+kubebuilder:webhook:path=/mutate-simulation-kube-scheduler-simulator-x-k8s-io-v1alpha1-scenario,mutating=true,failurePolicy=fail,sideEffects=None,groups=simulation.kube-scheduler-simulator.x-k8s.io,resources=scenarios,verbs=create;update,versions=v1alpha1,name=mscenario.kb.io,admissionReviewVersions=v1
