...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (s *ScenarioOperation) DeepCopyInto(out *ScenarioOperation) {
	*out = *s
	if s.Create != nil {
		in, out := &s.Create, &out.Create
		*out = new(CreateOperation)
		(*in).DeepCopyInto(*out)
	}
	if s.Patch != nil {
		in, out := &s.Patch, &out.Patch
		*out = new(PatchOperation)
		(*in).DeepCopyInto(*out)
	}
	if s.Delete != nil {
		in, out := &s.Delete, &out.Delete
		*out = new(DeleteOperation)
		(*in).DeepCopyInto(*out)
	}
	if s.Done != nil {
		in, out := &s.Done, &out.Done
		*out = new(DoneOperation)
		**out = **in
	}
}
...
func (s *ScenarioOperation) DeepCopy() *ScenarioOperation {
	if s == nil {
		return nil
	}
