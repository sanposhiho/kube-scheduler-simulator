...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScenarioEvent) DeepCopyInto(out *ScenarioEvent) {
	*out = *in
	if in.CreateOperation != nil {
		in, out := &in.CreateOperation, &out.CreateOperation
		*out = new(CreateOperation)
		(*in).DeepCopyInto(*out)
	}
	if in.PatchOperation != nil {
		in, out := &in.PatchOperation, &out.PatchOperation
		*out = new(PatchOperation)
		(*in).DeepCopyInto(*out)
	}
	if in.DeleteOperation != nil {
		in, out := &in.DeleteOperation, &out.DeleteOperation
		*out = new(DeleteOperation)
		(*in).DeepCopyInto(*out)
	}
	if in.DoneOperation != nil {
		in, out := &in.DoneOperation, &out.DoneOperation
		*out = new(DoneOperation)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScenarioEvent.
func (in *ScenarioEvent) DeepCopy() *ScenarioEvent {
	if in == nil {
		return nil
	}
	out := new(ScenarioEvent)
	in.DeepCopyInto(out)
	return out
}
